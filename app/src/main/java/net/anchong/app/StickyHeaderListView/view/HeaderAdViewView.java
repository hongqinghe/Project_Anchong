...
import net.anchong.app.StickyHeaderListView.adapter.HeaderAdAdapter;
import net.anchong.app.StickyHeaderListView.manager.ImageManager;
import net.anchong.app.StickyHeaderListView.util.DensityUtil;
