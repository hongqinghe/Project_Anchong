...
import net.anchong.app.ui.ShopSendOutActivity;
 ...
 */
public class ShopAllOrderAdapter extends BaseAdapter {
    ...
    public ShopAllOrderAdapter(Context mContext, LayoutInflater mInflater, ShopAllOrderFragment shopAllOrderFragment, ShopOrderResponse shopOrderResponse, List<ShopOrderResponse.ResultDataEntity.Order> orders) {
        this.mContext = mContext;
        this.mInflater = mInflater;
        this.shopAllOrderFragment = shopAllOrderFragment;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (state) {
            case "1":
                ...
                vh.action1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        shopAllOrderFragment.orderAction("6",orders.get(position));
                    }
                });
                break;
            case "2":
                ...
                vh.action1.setImageDrawable(mContext.getResources().getDrawable(R.drawable.no_logistics));
                vh.action1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        shopAllOrderFragment.orderAction("3", orders.get(position));
                    }
                });
                vh.action2.setImageDrawable(mContext.getResources().getDrawable(R.drawable.manual));
                vh.action2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ShopSendOutActivity.start(mContext, orders.get(position));
                    }
                });
                break;
            case "3":
                vh.orderState.setText("已发货");
                vh.action.setVisibility(View.VISIBLE);
                vh.action1.setVisibility(View.VISIBLE);
                vh.action1.setImageDrawable(mContext.getResources().getDrawable(R.drawable.check_logistics));
                vh.action1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
            ...
            case "4":
                ...
                break;
            case "5":
                vh.orderState.setText("已退款");
                vh.action.setVisibility(View.GONE);
                break;
            case "6":
                vh.orderState.setText("交易关闭");
                vh.action.setVisibility(View.GONE);
                break;
            case "7":
                vh.orderState.setText("交易成功");
                vh.action.setVisibility(View.GONE);
                break;
        }
