...
public class SendOrderAdapter extends BaseAdapter {
    ...
    private SendOrderFragment mFragmetn;
    ...
    public SendOrderAdapter(Context mContext, LayoutInflater mInflater, SendOrderFragment mFragmetn, OrderInfoResponse orderInfoResponse, List<OrderInfoResponse.ResultDataEntity.ListEntity> orders, OrderInfoActivity orderInfoActivity) {
