...
import net.anchong.app.ui.MyCommunityInfoActivity;
...
public class MyCommunityAdapter extends BaseAdapter {
    ...
    private List<MyCommunityResponse.ResultDataEntity.ListEntity> listBeans = null;

    public MyCommunityAdapter(Context context, LayoutInflater mInflater, List<MyCommunityResponse.ResultDataEntity.ListEntity> listBeans) {
        this.context = context;
        this.mInflater = mInflater;
        this.listBeans = listBeans;
    }

    public MyCommunityAdapter(Context context, LayoutInflater mInflater) {
        this.context = context;
        this.mInflater = mInflater;
    }


    public void setList(List<MyCommunityResponse.ResultDataEntity.ListEntity> listBeans) {
        this.listBeans = listBeans;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listBeans == null || listBeans.size() <= 0) {
            convertView = mInflater.inflate(R.layout.view_community_my_empty, null);
        } else {
            ViewHoler vh = null;
            if (convertView == null) {
                vh = new ViewHoler();
                convertView = mInflater.inflate(R.layout.item_community_my, null);
            ...
            final MyCommunityResponse.ResultDataEntity.ListEntity listBean = listBeans.get(position);
...
//        vh.tag.setText(listBean.getTag());
            ...
            vh.community.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    MyCommunityInfoActivity.start(context, listBean.getChat_id()+"");
                }
            });
        }
