...
public class ReceiveOrderAdapter extends BaseAdapter {
    ...
    private ReceiveOrderFragment mFragmetn;
    ...
    public ReceiveOrderAdapter(Context mContext, LayoutInflater mInflater, ReceiveOrderFragment mFragmetn, OrderInfoResponse orderInfoResponse, List<OrderInfoResponse.ResultDataEntity.ListEntity> orders) {
