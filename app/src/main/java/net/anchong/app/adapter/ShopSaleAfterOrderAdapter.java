 ...
 */
public class ShopSaleAfterOrderAdapter extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private ShopSaleAfterOrderFragment shopSaleAfterOrderFragment;
    private ShopOrderResponse shopOrderResponse;
    private List<ShopOrderResponse.ResultDataEntity.Order> orders = new ArrayList<>();

    public ShopSaleAfterOrderAdapter(Context mContext, LayoutInflater mInflater, ShopSaleAfterOrderFragment shopSaleAfterOrderFragment, ShopOrderResponse shopOrderResponse, List<ShopOrderResponse.ResultDataEntity.Order> orders) {
        this.mContext = mContext;
        this.mInflater = mInflater;
        this.shopSaleAfterOrderFragment = shopSaleAfterOrderFragment;
            ...
            case "4":
                ...
                vh.action1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        shopSaleAfterOrderFragment.orderAction("3", orders.get(position));
                    }
                });
