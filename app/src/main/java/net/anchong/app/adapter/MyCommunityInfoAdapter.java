 ...
 */
public class MyCommunityInfoAdapter extends BaseAdapter {

    private Context context;
    private LayoutInflater mInflater;
    private MyCommunityInfoActivity myCommunityInfoActivity;
    private List<CommunityComResponse.ResultDataEntity.ListEntity> listBeans = null;

    public MyCommunityInfoAdapter(Context context, LayoutInflater mInflater, MyCommunityInfoActivity myCommunityInfoActivity, List<CommunityComResponse.ResultDataEntity.ListEntity> listBeans) {
        this.context = context;
        this.mInflater = mInflater;
        this.myCommunityInfoActivity = myCommunityInfoActivity;
        this.listBeans = listBeans;
    }

    public MyCommunityInfoAdapter(Context context, LayoutInflater mInflater) {
        this.context = context;
        this.mInflater = mInflater;
    }
        ...
        if (listBeans == null || listBeans.size() <= 0) {
            ...
            vh.comnum.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    myCommunityInfoActivity.clickeCom(listBean.getComid(),listBean.getName());
                }
            });
