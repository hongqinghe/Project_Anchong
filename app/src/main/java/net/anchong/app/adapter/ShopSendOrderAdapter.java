 ...
 */
public class ShopSendOrderAdapter extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private ShopSendOrderFragment shopSendOrderFragment;
    private ShopOrderResponse shopOrderResponse;
    private List<ShopOrderResponse.ResultDataEntity.Order> orders = new ArrayList<>();

    public ShopSendOrderAdapter(Context mContext, LayoutInflater mInflater, ShopSendOrderFragment shopSendOrderFragment, ShopOrderResponse shopOrderResponse, List<ShopOrderResponse.ResultDataEntity.Order> orders) {
        this.mContext = mContext;
        this.mInflater = mInflater;
        this.shopSendOrderFragment = shopSendOrderFragment;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        vh.action1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                shopSendOrderFragment.orderAction("3", orders.get(position));
            }
        });
