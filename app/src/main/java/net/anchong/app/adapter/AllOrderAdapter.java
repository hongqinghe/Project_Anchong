...
public class AllOrderAdapter extends BaseAdapter {
    ...
    private AllOrderFragment mFragmetn;
    ...
    public AllOrderAdapter(Context mContext, LayoutInflater mInflater, AllOrderFragment mFragmetn, OrderInfoResponse orderInfoResponse, List<OrderInfoResponse.ResultDataEntity.ListEntity> orders, OrderInfoActivity orderInfoActivity) {
