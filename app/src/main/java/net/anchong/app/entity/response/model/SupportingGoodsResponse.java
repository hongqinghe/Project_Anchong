 ...
 */
public class SupportingGoodsResponse extends ResponseResult implements Serializable {


    /**
     * total : 17
     * list : [{"gid":"货品ID","title":"货品名称","price":"货品价格","img":"货品图片","goods_id":"商品ID"},{"gid":"货品ID","title":"货品名称","price":"货品价格","img":"货品图片","goods_id":"商品ID"}]
     */
    ...
    @Override
    public String toString() {
        return "SupportingGoodsResponse{" +
