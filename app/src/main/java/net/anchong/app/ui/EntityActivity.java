 ...
 */
public class EntityActivity extends BaseActivity implements GeneralTitleBarView.GeneralTitleBarOnclickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_activity_entity);
        x.view().inject(this);
        //初始化数据
        initData();
        //初始化视图
    ...
    private void initView() {
        mGeneralTitleBarView.setData("个体", "保存");
