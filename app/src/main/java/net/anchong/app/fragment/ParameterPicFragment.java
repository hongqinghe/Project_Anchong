 ...
 */
public class ParameterPicFragment extends BaseFragment {
    ...
    private void initData() {
        pd.show();
        urlPath = GoodsInformationActivity.goodsINfoResultModel.getResultData().getParameterpic();
//        urlPath = GoodsInformationActivity.goodsINfoResultModel.getResultData().getDetailpic();
