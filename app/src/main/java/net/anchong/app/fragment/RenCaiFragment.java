 ...
 */
public class RenCaiFragment extends BaseFragment implements XListView.IXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mInflater = inflater;
        view = inflater.inflate(R.layout.fragment_rencai, container, false);
    ...
    private void initData() {
        ...
        page = 1;
        listEntities.clear();
        MybusinessinfoRequestParamModel requestParamModel = new MybusinessinfoRequestParamModel("4", "", page + "");
    ...
    private void initView() {
        pd.dismiss();
        adapter = new FaBaoAdapter(mContext, this, mInflater, listEntities, "招聘人才");
