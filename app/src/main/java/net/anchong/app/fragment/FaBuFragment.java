 ...
 */
public class FaBuFragment extends BaseFragment implements XListView.IXListViewListener {
    ...
    private void initData() {
        ...
        page = 1;
        listEntities.clear();
        MybusinessinfoRequestParamModel requestParamModel = new MybusinessinfoRequestParamModel("3", "", page + "");
    ...
    private void initView() {
        pd.dismiss();
        adapter = new FaBaoAdapter(mContext, this, mInflater, listEntities, "发布人才");
