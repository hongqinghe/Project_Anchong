 ...
 */
public class CommunityInfoHeaderView extends LinearLayout {
...
//    private TextView tag;
    ...
    public CommunityInfoHeaderView(Context context) {
        super(context);
    ...
    public CommunityInfoHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initData();
        initView();
    ...
    private void initView() {
        View.inflate(mContext, R.layout.view_headerview_community_info, this);
