 ...
 */
public class GoodsThreeView extends LinearLayout {

    private Context mContext;

    @ViewInject(R.id.tv_goods_three_name)
    ...
    public GoodsThreeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }
    ...
    private void initView() {
        View.inflate(mContext, R.layout.view_goods_three, this);
        x.view().inject(this);
    }

    public void setData(GoodsAdvertResponse.ResultDataEntity.ThreeEntity threeEntity, final int shopPrice) {
        if (!TextUtils.isEmpty(threeEntity.getName())) {
            name.setText(threeEntity.getName());
        }

        final List<GoodsAdvertResponse.ResultDataEntity.ThreeEntity.ListEntity> pics = threeEntity.getList();
        if (pics != null) {
