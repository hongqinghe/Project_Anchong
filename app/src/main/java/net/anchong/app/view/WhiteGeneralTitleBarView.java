 ...
 */
public class WhiteGeneralTitleBarView extends LinearLayout implements View.OnClickListener {
    ...
    public WhiteGeneralTitleBarView(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public WhiteGeneralTitleBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }
    ...
    private void initView() {
        View.inflate(mContext, R.layout.view_white_general_titlebar, this);
        x.view().inject(this);
